$(document).ready(function() {
    ...
    ajaxFunction = function(gallery) {
        $.ajax({
            url: "/api/aiScore/trancrule",
            type: "POST",
            data: JSON.stringify({ "rule": ruleValue, "tranc": trancValue}),
